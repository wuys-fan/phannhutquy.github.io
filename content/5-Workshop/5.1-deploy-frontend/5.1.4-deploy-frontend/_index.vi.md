...
![Thành quả build ReactJS](/phannhutquy.github.io/images/1-Worklog/react_build_output.png)
...
![Tạo CloudFront Distribution](/phannhutquy.github.io/images/5-Workshop/cloudfront-create.png)

Sau khi kích hoạt WAF, hệ thống tự động thiết lập một **Web ACL** bảo vệ để kiểm soát lưu lượng truy cập:
![Danh sách Web ACLs của WAF](/phannhutquy.github.io/images/5-Workshop/waf-web-acl.png)
...
![Giao diện Pet Resort trên CloudFront](/phannhutquy.github.io/images/5-Workshop/cloudfront-domain.png)
